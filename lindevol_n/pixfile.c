/* $Id: pixfile.c,v 1.2 2000/01/30 03:11:00 kim Exp $ */
/*
 * $Log: pixfile.c,v $
 ...
 *        "energyless" color
 *    (2) Colors 0x70 - 0x7f are used for special purposes:
 *        0x70: empty soil (black)
 *        0x71: nutrient containing soil (grey)
 *        0x7f: background "air" color.
 */

int write_pixfile(void)
{
  static long last_fpos = -1;
